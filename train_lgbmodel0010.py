# 2019-02-13 14:29:58 train_predict_lgb010 >>> [info] metrics.mean : 3.6441887869137806
# 2019-02-13 14:29:58 train_predict_lgb010 >>> [info] metrics.std : 0.09756995207732232

import addict
# from data_io import load_train_features, load_test_features
from data_io import load_train_newk_features, load_test_newk_features
...
def main():
    ...
    train_data = load_train_newk_features()
    ...
    test_data = load_test_newk_features()
