...
def main():
    ...
    features = list(features_df[features_df.fi_complex > 4.25].feature_name) + [col for col in train_data.columns if col.endswith("nmf100")]
    pd.DataFrame({"feature_name": features}).to_csv("./models/lgb031.csv", index=False)
    ...
    lgb_params.reg_alpha = 201.20067623048502
    lgb_params.reg_lambda = 218.1803519764758
    lgb_params.subsample = 0.7619958948645247
