...
def main():
    ...
    features = list(features_df[features_df.fi_complex > 2].feature_name)
    ...
    pd.DataFrame({"feature_name": features}).to_csv("./models/lgb038.csv", index=False)
