...
def main():
    ...
    features = list(features_df[features_df.fi_complex > 6].feature_name)
    ...
    pd.DataFrame({"feature_name": features}).to_csv("./models/lgb034.csv", index=False)
