...
def main():
    ...
    lgb_params.colsample_bytree = 0.6741643096978434
    lgb_params.max_depth = 6
    lgb_params.min_child_weight = 18.729849341798932
    lgb_params.min_data_in_leaf = 35
    lgb_params.min_split_gain = 9.392597290081879
    lgb_params.num_leaves = 81
    lgb_params.other_rate = 0.9276202680620784
    lgb_params.reg_alpha = 34.15461632987463
    lgb_params.reg_lambda = 47.667145386029524
    lgb_params.subsample = 0.8906115834855368
    lgb_params.top_rate = 0.03515344717026679
