...
# 2019-02-23 15:55:54 train_predict_xgb036 >>> [info] metrics.mean : 3.6415908333333333
# 2019-02-23 15:55:54 train_predict_xgb036 >>> [info] metrics.std : 0.012044333403675264
...
def main():
    ...
    pd.DataFrame({"feature_name": features}).to_csv("./models/xgb036.csv", index=False)
    ...
    xgb_params.eta = 0.02  # 0.005
    xgb_params.gamma = 0.533

    xgb_params.nrounds = 5000  # 5000
    ...
    xgb_params.boosting_type = 'gbtree'
    xgb_params.colsample_bytree = 0.19080406903424613
    xgb_params.max_depth = 8
    xgb_params.max_leaves = 125
    xgb_params.min_split_gain = 0.4758416450045546
    xgb_params.alpha = 237.60042941954896
    xgb_params["lambda"] = 19.607814182782022
    xgb_params.subsample = 0.46109355997337415

    model = XGBModel(xgb_params)
    print_info("xgb_params", model.model_params)
