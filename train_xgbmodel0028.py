...
def main():
    ...
    xgb_params.colsample_bytree = 0.4682815742905069
    xgb_params.max_depth = 7
    xgb_params.max_leaves = 23
    xgb_params.min_split_gain = 0.4758416450045546
    xgb_params.alpha = 201.20067623048502
    xgb_params["lambda"] = 218.1803519764758
    xgb_params.subsample = 0.7619958948645247
